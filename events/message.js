...
exports.run = (bot, message) => {
  ...
  try {
    ...
    //const baseCommand = splitCommand.shift();
    let routeFile = require(`../routes/${baseCommand}`);
    //logger.debug(`${baseCommand}.${prefixMap.get(prefix)}()`);
    
    //let commandFile = require(`../commands/${command}/${prefixMap.get(prefix)}.js`);    
